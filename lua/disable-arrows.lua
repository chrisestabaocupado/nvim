...
--
map('i', '<C-h>', '<CS-Left>', { noremap = true, silent = true })
map('i', '<C-l>', '<CS-Right>', { noremap = true, silent = true })
--map('n', '<S-hh>', '<CS-Left>', { noremap = true, silent = true })
--map('n', '<S-ll>', '<CS-Right>', { noremap = true, silent = true })
